...
set mapreduce.job.name=dmt_crm_mzjk_user_info_01;
set hive.exec.parallel=true;
set hive.exec.dynamic.partition.mode=nonstrict;

insert overwrite table dmt_crm.mzjk_user_info partition
  (stat_date)
  select 'SYS' as dw_create_by,
   ...
   where (t1.register_biz = 'mzjk' or t2.mzjk_first_apply_time is not null)
