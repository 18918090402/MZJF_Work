...
set mapreduce.job.name=dmt_crm_xyd_user_info_01;
set hive.exec.parallel=true;
set hive.exec.dynamic.partition.mode=nonstrict;

insert overwrite table dmt_crm.xyd_user_info partition
  (stat_date)
  select 'SYS' as dw_create_by,
   ...
   where (t1.register_biz = 'mxd' or t2.xyd_first_apply_time is not null)
