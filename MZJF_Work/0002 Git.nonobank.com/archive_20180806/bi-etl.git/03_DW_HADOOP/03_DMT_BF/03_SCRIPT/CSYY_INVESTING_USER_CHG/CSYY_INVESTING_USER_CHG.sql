set mapreduce.job.name = DMT_BF_CSYY_INVESTING_USER_CHG_01;
set mapreduce.job.queuename = etl-dw;
set hive.exec.dynamic.partition.mode=nonstrict;
set hive.exec.parallel=true;

insert overwrite table DMT_BF.CSYY_INVESTING_USER_CHG partition
  (STAT_DATE)
  select 'SYS' AS DW_CREATE_BY,
    ...
    from (select user_id, user_code, mobile_num, gender, real_name
            from DMT_BF.CSYY_INVESTING_USER
