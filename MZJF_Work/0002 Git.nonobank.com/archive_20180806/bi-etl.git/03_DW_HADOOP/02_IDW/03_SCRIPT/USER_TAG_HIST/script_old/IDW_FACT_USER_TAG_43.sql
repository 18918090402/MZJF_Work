...
set mapreduce.job.name=IDW_FACT_USER_TAG_43_01;
...
FROM 
(
  SELECT user_id, sum(WITHDRAW_AMT) CSYY_7DAYS_WITHDRAW_AMT
...
INSERT OVERWRITE TABLE IDW.USER_TAG_TMP_01 PARTITION(TAG_ID=180) SELECT  USER_ID,CSYY_7DAYS_WITHDRAW_AMT, 4
;
-- -------------------------------------------------------------------------------------------------
set mapreduce.job.queuename=etl-dw;

set mapreduce.job.name=IDW_FACT_USER_TAG_43_02;
