...
set mapreduce.job.name=IDW_FACT_USER_TAG_39_01;
...
FROM 
(
  SELECT user_id, sum(recharge_amt) NONO_7DAYS_RECHARGE_AMT
...
INSERT OVERWRITE TABLE IDW.USER_TAG_TMP_01 PARTITION(TAG_ID=176) SELECT  USER_ID,NONO_7DAYS_RECHARGE_AMT, 4
;
-- -------------------------------------------------------------------------------------------------
set mapreduce.job.queuename=etl-dw;

set mapreduce.job.name=IDW_FACT_USER_TAG_39_02;
