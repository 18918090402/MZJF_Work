...
select date_add('{LAST_DATA_TIME}',1) as stat_date
...
where to_date(plan_cash_time) > date_add('{LAST_DATA_TIME}',1})
and to_date(plan_cash_time) < date_add('{LAST_DATA_TIME}',91)
...
and date_add(lock_end_time,1) > date_add('{LAST_DATA_TIME}',1})
and date_add(lock_end_time,1) < date_add('{LAST_DATA_TIME}',91)
