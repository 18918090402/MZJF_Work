drop table if exists idw.FACT_IN_REPAY_BORROWS_SNAPSHOT;
create table if not exists idw.FACT_IN_REPAY_BORROWS_SNAPSHOT
(
   ...
   SHOULD_REPAY_EXTRA_FEE decimal(38,10) comment '应还额外费用',
   REPAYED_EXTRA_FEE    decimal(38,10) comment '已还额外费用',
   UNREPAY_EXTRA_FEE    decimal(38,10) comment '未还额外费用',
   REPAYED_EXTRA_FEE_THIS_MONTH decimal(38,10) comment '本月已还额外费用',
