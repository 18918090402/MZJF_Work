DROP TABLE IF EXISTS DMT_MXD.FACT_MXD_WW_DETAIL;
CREATE TABLE IF NOT EXISTS DMT_MXD.FACT_MXD_WW_DETAIL
(
...
,mod_money decimal(38,2) comment '委外当天逾期总额 '
