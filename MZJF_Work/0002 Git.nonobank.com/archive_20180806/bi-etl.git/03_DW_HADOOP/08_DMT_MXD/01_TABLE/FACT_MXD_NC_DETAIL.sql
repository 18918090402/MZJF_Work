DROP TABLE IF EXISTS DMT_MXD.FACT_MXD_NC_DETAIL;
CREATE TABLE IF NOT EXISTS DMT_MXD.FACT_MXD_NC_DETAIL
(
...
,start_overdue_price decimal(38,2) comment '截止取数时间的逾期总额'
