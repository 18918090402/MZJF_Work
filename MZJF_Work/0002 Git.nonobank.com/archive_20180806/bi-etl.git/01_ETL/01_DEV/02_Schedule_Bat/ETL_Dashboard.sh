...
monitoroutlog=/opt/data-integration/monitor/logs/monitor_$filedate.log
 ...
 # ---    ETL_DASHBOARD_MAIN ----
   ...
   /root/data-integration/kitchen.sh /file  /opt/data-integration/shipment_data/ETL_Dashboard/ETL_DASHBOARD_MAIN.kjb /level:Basic >> /opt/data-integration/etl_log/ETL_DASHBOARD_MAIN$etllog.log
