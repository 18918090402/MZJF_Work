...
SELECT
    ...
    round(bp.bp_rate_lender/100,6)                                                              loanRate,               --9.借款年利率
    round(bo.bo_price,2)                                                                        amount,                 --10.借款金额
    round(br2.br_price_b,2)                                                                     surplusAmount,          --11.剩余借款本金
    ...
    round(br.br_service_fee + bo.zx_price,2)                                                    serviceCost,            --14.服务费（元）
