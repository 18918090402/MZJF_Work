...
SELECT t1.sourceCode, t1.sourceProductCode, t1.surplusAmount, sum(cast(t2.invAmount as decimal(38,6))) invAmount, sum(cast(t2.redpackage as decimal(38,6))) redpackage, COUNT(1) count 
...
SELECT "CERT20190411026" as sourceCode, 
       ...
       cast(COUNT(1) as string) as count, 
       to_date(NOW()) as create_time 
FROM report_check.temp_scat_cred t1 WHERE (cast(surplusAmount as decimal(38,6)) - (cast(invAmount as decimal(38,6)) + cast(redpackage as decimal(38,6)))) > 5 
;
...
SELECT *
FROM report_check.temp_scat_cred t1 WHERE (cast(surplusAmount as decimal(38,6)) - (cast(invAmount as decimal(38,6)) + cast(redpackage as decimal(38,6)))) > 5 LIMIT 10;
