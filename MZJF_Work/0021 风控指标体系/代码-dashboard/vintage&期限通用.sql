...
set junfang.loan_prem4plus;
  where term in (12,24,36) and 201701 le ym_disbursed le 201810;
...
run;
	...
	run;
	%mend;
%nloss_vintage (ds=loan_pre, base1=product ,base2=term ,time_level=month );
%nloss_vintage (ds=loan_pre, base1=product_title ,base2=term ,time_level=month );