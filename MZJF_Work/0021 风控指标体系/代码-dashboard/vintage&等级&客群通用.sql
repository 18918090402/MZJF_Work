...
run;
data apply(keep=apply_no product score pj customer apply_Date );
set risk.apply_&day ;
if NEWUSER_FLAG=1 then customer="新客户";
else if NEWUSER_FLAG=0 then customer="老客户";
...
%nloss_vintage (ds=loan_pre_1, base1=product ,base2=customer ,time_level=month );
%nloss_vintage (ds=loan_pre_1, base1=product_title ,base2=customer ,time_level=month );